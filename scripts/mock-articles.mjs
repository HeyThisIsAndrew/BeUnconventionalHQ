...
const HEADLINES = [
  ...
  ['Ghost of Yotei Is The Best Looking Game On PS5', 'Gaming', 'video-images'],
  ...
  ['Nintendo Direct Broke Its Own Rules And It Absolutely Worked', 'Gaming', 'image'],
  ...
  ['Silksong Was Worth Every Single Year Of The Wait', 'Gaming', 'image'],
  ...
  ['The Wolverine Game Is Insomniac At Full Power', 'Gaming', 'no-image'],
  ...
  ['Elden Ring Nightreign Changed How I Play Souls Games', 'Gaming', 'image'],
  ...
  ['Hollow Knight And The Quiet Confidence Of Great Design', 'Gaming', 'image'],
